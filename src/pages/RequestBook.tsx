...
const RequestBook = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // For MVP, just show success. Backend integration later.
    setSubmitted(true);
  ...
  return (
    <main className="min-h-screen parchment-bg">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="font-display text-3xl font-bold text-foreground text-center md:text-4xl">
            Request a Book
          </h1>
          <p className="mt-3 text-center text-muted-foreground mb-10">
            Can't find what you're looking for? Tell us and we'll try to get it for you.
          </p>
          ...
          {submitted ? (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                We'll review your request and do our best to source "{form.bookTitle}" for you.
              </p>
