    ...
    <main className="min-h-screen parchment-bg">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          >
            <div className={`aspect-[2/3] w-full max-w-sm rounded-lg bg-gradient-to-b ${book.coverColor} overflow-hidden shadow-xl`}>
              <div className="flex h-full flex-col items-center justify-center p-8 text-center">
                <div className={`w-16 h-0.5 ${book.coverAccent} mb-6 opacity-60`} />
                ...
                <div className={`w-10 h-0.5 ${book.coverAccent} mt-6 opacity-40`} />
              </div>
            </div>
          </motion.div>
